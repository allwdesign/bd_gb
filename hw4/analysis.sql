...
ON A.an_id = O.ord_an
-- Берем '2020-02-13 00:00:00' + INTERVAL 8 DAY = '2020-02-13 00:00:00'
-- WHERE Orders.ord_datetime BETWEEN '2020-02-05 00:00:00' AND '2020-02-05 00:00:00' + INTERVAL 8 DAY;
-- WHERE Orders.ord_datetime BETWEEN '2020-02-05 00:00:00' AND '2020-02-13 00:00:00'
